...
- `Tracciamento` unifies ordinary cashflow entries, investment operations, and internal transfers. The initial movement-type picker stays compact; investment and transfer create/edit forms open as roomier sectioned dialogs with explicit Italian validation feedback and guarded save/delete behavior.
