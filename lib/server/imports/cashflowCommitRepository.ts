...
function mapBatch(id: string, data: Record<string, unknown>): CsvImportCashflowBatch {
  return {
    ...
    importRunId: typeof data.importRunId === 'string' ? data.importRunId : null,
    importChunkIndex: typeof data.importChunkIndex === 'number' ? data.importChunkIndex : null,
    importChunkCount: typeof data.importChunkCount === 'number' ? data.importChunkCount : null,
