...
export async function saveBudgetConfig(
  ...
  try {
    ...
    const cleanItems = items.map((item) => {
      ...
      if (normalized.attributionProfileId != null) clean.attributionProfileId = normalized.attributionProfileId;
      if (normalized.attributionProfileName != null) clean.attributionProfileName = normalized.attributionProfileName;
      if (normalized.attributionSplits != null) clean.attributionSplits = normalized.attributionSplits;
      return clean;
    });
