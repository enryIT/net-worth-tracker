 ...
 */
export function getItalyDate(date: DateInput = new Date()): Date {
 ...
 */
export function getItalyMonth(date: DateInput = new Date()): number {
 ...
 */
export function getItalyYear(date: DateInput = new Date()): number {
  const italyDate = getItalyDate(date);
 ...
 */
export function getItalyMonthYear(date: DateInput = new Date()): { month: number; year: number } {
  const italyDate = getItalyDate(date);
  return {
 ...
 */
export function formatDateInputValue(date: DateInput = new Date()): string {
  const italyDate = getItalyDate(date);
