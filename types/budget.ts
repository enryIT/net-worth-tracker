...
export interface BudgetItem {
  ...
  scope: BudgetScope;
  period: BudgetPeriod;
  // Populated only for scope='type' — income targets use expenseType='income'; transfer is excluded.
...
export interface BudgetComparison {
  ...
  // currentYearTotal / annual budget equivalent (amount, or amount × 12 if monthly)
